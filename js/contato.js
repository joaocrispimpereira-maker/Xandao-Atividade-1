...
parag2.innerText = "email: contato@annabella.com.br";
parag2.className = "parag2";

let parag3 = document.createElement("p");
parag3.innerText = "telefone: (11) 9978-6589";
parag3.className = "parag3";
